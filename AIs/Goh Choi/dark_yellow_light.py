...
class DarkYellowLightAI(PlayerAIBase):
    ...
    MAX_BUY_PARM_FAC = 120
    MIN_BUY_PARM_FAC = 50
    MAX_BID_PARM_FAC = 150
    MIN_BID_PARM_FAC = 90
    BID_PARM_INC_UNIT = 40
    MAX_BID_PARM_DEC_UNIT = 10
    MAX_HOLDOUT_FAC = 500
    MIN_HOLDOUT_FAC = 150
    HOLDOUT_ADJUST_UNIT = 50
    HOLDOUT_BID_RATIO = 90
    HOLDOUT_BIG_FAC = 1000000

    NOT_GONNA_HAPPEN = 0.0017
    BARELY_HAPPENS = 0.020
    # for second_cash_reserve
    MIGHT_HAPPEN = 0.09414
    RISK_AVRG_FACTOR = 15.0
