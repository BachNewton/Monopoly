...
class DarkRedLightAI(PlayerAIBase):
    ...
    MAX_BUY_PARM_FAC = 200
    MIN_BUY_PARM_FAC = 30
    MAX_BID_PARM_FAC = 300
    MIN_BID_PARM_FAC = 60
    BID_PARM_INC_UNIT = 60
    MAX_BID_PARM_DEC_UNIT = 20
    MAX_HOLDOUT_FAC = 500
    MIN_HOLDOUT_FAC = 170
    HOLDOUT_ADJUST_UNIT = 60
    HOLDOUT_BID_RATIO = 80
    HOLDOUT_BIG_FAC = 1000000

    NOT_GONNA_HAPPEN = 0.002
    BARELY_HAPPENS = 0.030
    # for second_cash_reserve
    MIGHT_HAPPEN = 0.11265
    RISK_AVRG_FACTOR = 13.0
